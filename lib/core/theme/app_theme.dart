...
abstract final class FlickColors {
  ...
  static const surfaceDim = Color(0xFFF0EDE8);

  // Brand
  static const primary    = Color(0xFF3D5AFE); // calm indigo
  static const primaryDim = Color(0xFFE8ECFF);

  // Semantic
  static const success    = Color(0xFF3DAA76);
  static const successDim = Color(0xFFE6F7EF);
  static const error      = Color(0xFFE05252);
  static const errorDim   = Color(0xFFFDECEC);
  static const warning    = Color(0xFFF5A623);

  // Text
  static const textPrimary   = Color(0xFF1A1A2E);
  static const textSecondary = Color(0xFF6B7280);
  static const textMuted     = Color(0xFFADB5C2);

  // Borders
  static const border        = Color(0xFFE5E2DC);
  static const borderFocused = Color(0xFF3D5AFE);
}
